...
def keep_alive():
    ...
    t.daemon = True
    t.start()
    print(f"Flask Keep-Alive server started on port {os.environ.get('PORT', 8080)}")
# --- End Flask Keep Alive ---

# --- Configuration ---
TOKEN = '8332213003:AAG9PbZ8yT_YohDUw5kh_dkDQbTPH0lYlgY'
OWNER_ID = 7755338110
ADMIN_ID = 7755338110
YOUR_USERNAME = '@Ronju360'
UPDATE_CHANNEL = 'https://t.me/ronjumodz'
